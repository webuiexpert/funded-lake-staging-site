...
function OneFiftyPriceCard({evaluationActivateFee, fundedActivateFee}) {
  ...
  const evaluationSteps = [
    { label: "Profit Target", value: "9000", description: "The profit target needed to pass the eval" },
    { label: "Max Loss Limit", value: "4500", description: "EOD trailing drawdown" },
    ...
    { label: "News Trading", value: "Yes", description: "" },
    { label: "Max Contract Size", value: "10 Minis", description: "" },
  ...
  const fundedSteps = [
    ...
    { label: "Max Contract Size", value: "5 Minis", description: "" },
...
export default OneFiftyPriceCard