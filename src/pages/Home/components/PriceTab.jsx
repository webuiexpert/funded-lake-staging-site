              ...
              <Tabs className="priceTab md:text-[14px] lg:max-w-5xl max-w-full mx-auto md:mb-0 mb-6 font-bold text-sm text-white relative z-20">
                ...
                <TabPanel className="one-step InnerPriceTab mt-10 lg:text-lg">
                  <Tabs>
                    ...
                    <TabPanel className="25K">
                      <OneStepPriceCard />
                      <PriceTableBtns goalDiscount="20%" couponCode="FL20" oldAmount="$190"  newAmount="152$" accountAmt="25K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=100" />
                    </TabPanel>
                    <TabPanel className="50K">
                      <OneStepPriceCard />
                      <PriceTableBtns goalDiscount="20%" couponCode="FL20" oldAmount="$375"  newAmount="300$" accountAmt="50K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=101" />
                    </TabPanel>
                    <TabPanel className="100K">
                      <OneStepPriceCard />
                      <PriceTableBtns goalDiscount="20%" couponCode="FL20" oldAmount="$750"  newAmount="600$" accountAmt="100K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=102" />
                    </TabPanel>
                    <TabPanel className="250K">
                      <OneStepPriceCard />
                      <PriceTableBtns goalDiscount="20%" couponCode="FL20" oldAmount="$2000" newAmount="1600$"  accountAmt="250K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=103" />
                    </TabPanel>
                    <TabPanel className="400K">
                      <OneStepPriceCard />
                      <PriceTableBtns goalDiscount="20%" couponCode="FL20" oldAmount="$3,600" newAmount="2,880$"  accountAmt="400K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=104" />
                ...
                <TabPanel className="instant  InnerPriceTab lg:text-lg mx-auto">
                  <Tabs>
                    ...
                    <TabPanel className="5K">
                      <InstantPriceCard />
                      <PriceTableBtns goalDiscount="25%" couponCode="GOAL25"  couponCode="GOAL25" oldAmount="$200" newAmount="160$" accountAmt="5K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=180" />
                    </TabPanel>
                    <TabPanel className="10K">
                      <InstantPriceCard />
                      <PriceTableBtns goalDiscount="25%" couponCode="GOAL25"  oldAmount="$400" accountAmt="10K" newAmount="320$" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=181" />
                    </TabPanel>
                    <TabPanel className="25K">
                      <InstantPriceCard />
                      <PriceTableBtns goalDiscount="25%" couponCode="GOAL25"  oldAmount="$1,125" accountAmt="25K" newAmount="900$" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=182" />
                    </TabPanel>
                    <TabPanel className="50K">
                      <InstantPriceCard />
                      <PriceTableBtns goalDiscount="25%" couponCode="GOAL25"  oldAmount="$2,500" accountAmt="50K" newAmount="2000$" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=183" />
                    </TabPanel>
                    <TabPanel className="100K">
                      <InstantPriceCard />
                      <PriceTableBtns goalDiscount="25%" couponCode="GOAL25"  oldAmount="$5,000" accountAmt="100K"newAmount="4000$"  getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=184" />
                    </TabPanel>
                    {/* <TabPanel className="250K">
                      <OneStepPriceCard />
