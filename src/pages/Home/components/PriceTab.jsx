                ...
                <TabPanel className="one-step InnerPriceTab mt-10 lg:text-lg">
                  <Tabs>
                    ...
                    <TabPanel className="5K">
                      <OneStepPriceCard />
                      <PriceTableBtns offerDiscountBtn={true}
                                limitedTime={true} goalDiscount="20%" couponCode="FL20" newAmount="$35" accountAmt="5K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=99" />
                    </TabPanel>
                    <TabPanel className="10K">
                      <OneStepPriceCard />
                      <PriceTableBtns offerDiscountBtn={true}
                                limitedTime={true} goalDiscount="20%" couponCode="FL20" newAmount="$75" accountAmt="10K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=99" />
                    </TabPanel>
                    <TabPanel className="25K">
                      <OneStepPriceCard />
                      <PriceTableBtns goalDiscount="30%" couponCode="FL20" oldAmount="$190"  newAmount="133$" accountAmt="25K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=100" />
                    </TabPanel>
                    <TabPanel className="50K">
                      <OneStepPriceCard />
                      <PriceTableBtns goalDiscount="30%" couponCode="FL20" oldAmount="$375"  newAmount="262.5$" accountAmt="50K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=101" />
                    </TabPanel>
                    <TabPanel className="100K">
                      <OneStepPriceCard />
                      <PriceTableBtns goalDiscount="30%" couponCode="FL20" oldAmount="$750"  newAmount="525$" accountAmt="100K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=102" />
                    </TabPanel>
                    <TabPanel className="250K">
                      <OneStepPriceCard />
                      <PriceTableBtns goalDiscount="30%" couponCode="FL20" oldAmount="$2000" newAmount="1400$"  accountAmt="250K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=103" />
                    </TabPanel>
                    <TabPanel className="400K">
                      <OneStepPriceCard />
                      <PriceTableBtns goalDiscount="30%" couponCode="FL20" oldAmount="$3,600" newAmount="2,520$"  accountAmt="400K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=104" />
                ...
                <TabPanel className="instant  InnerPriceTab lg:text-lg mx-auto">
                  <Tabs>
                    ...
                    <TabPanel className="5K">
                      <InstantPriceCard />
                      <PriceTableBtns offerDiscountBtn={true}
                                limitedTime={true} goalDiscount="20%" couponCode="FL20" oldAmount="$200" newAmount="160$" accountAmt="5K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=180" />
                    </TabPanel>
                    <TabPanel className="10K">
                      <InstantPriceCard />
                      <PriceTableBtns offerDiscountBtn={true}
                                limitedTime={true} goalDiscount="20%" couponCode="FL20"  oldAmount="$400" accountAmt="10K" newAmount="320$" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=181" />
                    </TabPanel>
                    <TabPanel className="25K">
                      <InstantPriceCard />
                      <PriceTableBtns goalDiscount="30%" couponCode="FL20"  oldAmount="$1,125" accountAmt="25K" newAmount="787.5$" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=182" />
                    </TabPanel>
                    <TabPanel className="50K">
                      <InstantPriceCard />
                      <PriceTableBtns goalDiscount="30%" couponCode="FL20"  oldAmount="$2,500" accountAmt="50K" newAmount="1750$" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=183" />
                    </TabPanel>
                    <TabPanel className="100K">
                      <InstantPriceCard />
                      <PriceTableBtns goalDiscount="30%" couponCode="FL20"  oldAmount="$5,000" accountAmt="100K"newAmount="3500$"  getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=184" />
                    </TabPanel>
                    {/* <TabPanel className="250K">
                      <OneStepPriceCard />
                      <PriceTableBtns goalDiscount="40%" couponCode="GOAL40" oldAmount="$2000" newAmount="$21"  accountAmt="250K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=103" />
                    </TabPanel>
                    <TabPanel className="400K">
                      <OneStepPriceCard />
                      <PriceTableBtns goalDiscount="40%" couponCode="GOAL40" oldAmount="$3,600" newAmount="$21" accountAmt="400K" getFundedLink="https://fundedlakedashboard.propaccount.com/en/challenges?planid=104" />
                    </TabPanel> */}
                  </Tabs>
                </TabPanel>
              </Tabs>
