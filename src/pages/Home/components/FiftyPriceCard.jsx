...
function FiftyPriceCard() {
  ...
  const evaluationSteps = [
    { label: "Profit Target", value: "3000", description: "" },
    { label: "Max Loss Limit", value: "2000", description: "" },
  ...
  const fundedSteps = [
    ...
    { label: "Max Contract Size", value: "2 Mins", description: "" },
