...
function SuccessStory() {
  return (
    <div className="md:py-16 lg:px-0 px-4 py-10 relative">
      ...
      <div className="success-story lg:mt-16 md:mt-12 mt-6 lg:mb-24 md:mb-16 mb-10 rounded-4xl z-[1] relative md:text-left text-center md:max-w-7xl mx-auto md:px-8 md:py-8 px-3 py-5 lg:p-12 shadow-lg">
